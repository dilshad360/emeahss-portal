...
const CommunityPDF = (props) => {
  ...
  return (
    <Document>
        {console.log(formValues.SportsStateLevel)}
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <View style={styles.field}>
            <View style={styles.values}>
              <Text style={{ marginBottom: "5px" }}>
                Single Window Appln No
              </Text>
            </View>
            <View>
              <Text style={{ marginBottom: "5px" }}>
                : {formValues.SingleWindowNo}
              </Text>
            </View>
          </View>
          ...
          <View style={{ paddingLeft: "20px", marginTop: "30px" }}>
            ...
            >
              19. Whether the applicant is eligible for bonus points under the
              following category :{" "}
            </Text>
            <Text style={{ fontSize: "11px", marginBottom: "10px" }}>
              {formValues.ExtraCurricular}
            </Text>
          </View>
          <View style={{ paddingLeft: "20px" }}>
            ...
            <View>
              ...
              >
                State Level Participation(Write the number of items
                participated) : {formValues.SportsStateLevel}
              </Text>
            </View>
          </View>
          <View>
          ...
          >
            <View style={styles.tableColumn}>
              ...
              <Text style={styles.tableCell}>{formValues.SportsDistrictA}</Text>
            </View>
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>B Grade</Text>
              <Text style={styles.tableCell}>{formValues.SportsDistrictB}</Text>
            </View>
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>C Grade</Text>
              <Text style={styles.tableCell}>{formValues.SportsDistrictC}</Text>
            </View>
            <View style={styles.tableColumn}>
          ...
          <View style={{ paddingLeft: "20px" }}>
            ...
            >
              21. Participation in Kerala School Kalotsavam
            </Text>
            <View>
              <Text
                style={{
              ...
              >
                State Level Participation(Write the number of items
                participated) : {formValues.KalotsavamStateLevel}
              </Text>
            </View>
          </View>
          <View>
          ...
          >
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>A Grade</Text>
              <Text style={styles.tableCell}>{formValues.ArtsDistrictA}</Text>
            </View>
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>B Grade</Text>
              <Text style={styles.tableCell}>{formValues.ArtsDistrictB}</Text>
            </View>
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>C Grade</Text>
              <Text style={styles.tableCell}>{formValues.ArtsDistrictC}</Text>
            </View>
            <View style={styles.tableColumn}>
              <Text style={styles.tableCellh}>Participation</Text>
              <Text style={styles.tableCell}>
          ...
          >
            22. Whether qualified in the National/State Level Test for the
            National Talent Search Examination :{" "}
            {formValues.NationalOrStateLevelExamination}
          </Text>
          ...
          >
            (a) Details of participation in co-curricular activites. Write the
            number of grades won in the relevant boxes.
          </Text>
          <View style={styles.tableContainer}>
            {/* Table header */}
            <View style={styles.tableHeader}>
          ...
          <Text style={{ fontSize: "11px", paddingLeft: "20px" }}>
            We do hereby declare that the information furnished above is true
            and correct to the best of my knowledge and belief. We know that
            faulty information may lead to the cancellation of the canidate.
          </Text>
