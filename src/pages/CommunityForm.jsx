...
import { schoolOptions, kondottyWardOptions, pullikkalWardOptions, YesNo } from "../Const";
        ...
        >
            {({ errors, touched }) => (
                <FormContainer>
                    ...
                    <CourseInput />
                    <Typography variant="subtitle1" className="pt-4" textAlign={'start'} gutterBottom>
                    ...
                    {/*********** Sports Section *************/}
                    <Typography variant="subtitle1" className="pt-4" fontWeight={'bold'} textAlign={'start'} gutterBottom>
                    ...
                    <Grid container spacing={2} alignItems='center'>
                        ...
                        <Grid item xs={12} sm={6}>
                            <Field
                                as={TextField}
                                name="SportsDistrictLevel"
                                label="The number of items participated"
                                type="text"
                                fullWidth
                            />
                        </Grid>
                    ...
                    <Typography variant="subtitle1" className="pt-4" textAlign={'start'} gutterBottom>
                        District Level (Write the number of grades won in the relevant boxes):
                    </Typography>
                    <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={6}>
                        <SelectInput
                            name="National/StateLevelExamination"
